...
.pull-left[
  ...
  You will need to learn two things to do data work in Python:
  * Read and write Python code
  * Think slightly different about work flow in data work
]
...
* How to document original data used as input:
...
.pull-right[
  **Code should be both correct code and good code.**
  ...
  and it can be understood by the team members.
