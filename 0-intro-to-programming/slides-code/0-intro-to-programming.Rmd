...
* **Library:** Code packages developed by others to solve difficult tasks but made easy to use in any project
...
.pull-left[
  ...
  **A script is file with code** 
  ...
  (_not the formal definition_).
  
  Compare with software that is meant to use different code
  depending on how each user interacts with it.
